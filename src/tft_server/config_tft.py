...
class TFTTrainConfig:
    ...
    def outputs_root(self) -> Path:
        return self.project_dir / "submissions"
    ...
    def dataset_config(self) -> dict[str, Any]:
        return {
            ...
            "min_encoder_length": max(1, min(self.min_history_points, self.max_encoder_length)),
...
def build_parser(description: str) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--artifacts-dir", type=Path, default=PROJECT_ROOT / "checkpoints")
