...
from ...configs import DEFAULT_CATBOOST_PARAMS
from ..eda_utils import build_train_eda_bundle
from ..cache import _cache_path
from ..fallback import _build_fallback_tables, build_hierarchical_fallback_predictions
from ..features.aggregates import _apply_stat_feature_tables, _build_prior_aggregate_bundle, _build_stat_feature_tables
from ..features.panel import _cross_join_pairs_and_dates
from ..io import _load_model_reference_assets, read_train_chunks
from ..metrics import weighted_rmsle
from ..paths import DATA_DIR, SUBMISSIONS_DIR
from ..validation import build_rolling_origin_folds
from .common import CATEGORICAL_FEATURES, TS_BASE_FEATURES, _attach_common_features
...
def train_final_catboost_model(
    ...
    submission_path = SUBMISSIONS_DIR / f"submission_catboost_optuna_lb{lookback_days}.csv.gz"
